...
public class MultiMapViewDemo extends FragmentActivity {
    ...
    /*北京为地图中心，logo在左上角，影藏百度的logo*/
        ...
        // 隐藏百度的LOGO
        View child = map1.getMapView().getChildAt(1);
    ...
    /*深圳为地图中心，不显示缩放控制按钮，logo在右下角*/
        ...
        map4.getBaiduMap().showMapPoi(true);
        map3.getMapView().showZoomControls(false);
